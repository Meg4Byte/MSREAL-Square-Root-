...
HD_PWD='/home/medivh/Vivado_projects/sqrt_2.0/sqrt_2.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sqrt_IP_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sqrt_IP_v1_0.tcl
